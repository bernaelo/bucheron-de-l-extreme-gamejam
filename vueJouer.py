...
class Vue(object):
    ...
    def __init__(self):
        ...
        self.walkLeft = [pygame.image.load('Bucheron-Run-Left0.png'), pygame.image.load('Bucheron-Run-Left1.png'),
                         pygame.image.load('Bucheron-Run-Left2.png'), pygame.image.load('Bucheron-Run-Left3.png'),
                         pygame.image.load('Bucheron-Run-Left4.png'), pygame.image.load('Bucheron-Run-Left5.png')]
        self.walkRight = [pygame.image.load('Bucheron-Run-Right0.png'), pygame.image.load('Bucheron-Run-Right1.png'),
                          pygame.image.load('Bucheron-Run-Right2.png'), pygame.image.load('Bucheron-Run-Right3.png'),
                          pygame.image.load('Bucheron-Run-Right4.png'), pygame.image.load('Bucheron-Run-Right5.png')]
        self.immobileDroite = [pygame.image.load('Bucheron-Stop-Right0.png'),
                               pygame.image.load('Bucheron-Stop-Right1.png')]
        self.immobileGauche = [pygame.image.load('Bucheron-Stop-Left0.png'),
                               pygame.image.load('Bucheron-Stop-Left1.png')]
        self.attaqueDroite = [pygame.image.load('att D0.png'), pygame.image.load('att D1.png'),
                              pygame.image.load('att D2.png'), pygame.image.load('att D3.png'),
                              pygame.image.load('att D4.png')]
        self.attaqueGauche = [pygame.image.load('att G0.png'), pygame.image.load('att G1.png'),
                              pygame.image.load('att G2.png'), pygame.image.load('att G3.png'),
                              pygame.image.load('att G4.png')]
        self.attaqueSpeDroite = [pygame.image.load('attSpe D0.png'), pygame.image.load('attSpe D1.png'),
                                 pygame.image.load('attSpe D2.png'), pygame.image.load('attSpe D3.png'),
                                 pygame.image.load('attSpe D4.png')]
        self.attaqueSpeGauche = [pygame.image.load('attSpe G0.png'), pygame.image.load('attSpe G1.png'),
                                 pygame.image.load('attSpe G2.png'), pygame.image.load('attSpe G3.png'),
                                 pygame.image.load('attSpe G4.png')]
        ...
        self.ressort = [pygame.image.load('Ressort0.png'), pygame.image.load('Ressort1.png'),
                        pygame.image.load('Ressort2.png')]
        self.levitation = [pygame.image.load('Antigravite0.png'), pygame.image.load('Antigravite1.png'),
                           pygame.image.load('Antigravite2.png'), pygame.image.load('Antigravite3.png'),
                           pygame.image.load('Antigravite4.png'), pygame.image.load('Antigravite5.png')]
        self.stopCount = 0
        self.walkCount = 0
    ...
    def Update(self, terrain, bu, fenetre, lesmechants, arbres, missil, temps):
        ...
        if (pygame.time.get_ticks() // 1000 - temps) % 60 < 10:
            temps = self.font.render("Temps : 0" + str((pygame.time.get_ticks() // 1000 - temps) // 60) + ":0" + str(
                (pygame.time.get_ticks() // 1000 - temps) % 60), 1, couleur)
        else:
            temps = self.font.render("Temps : 0" + str((pygame.time.get_ticks() // 1000 - temps) // 60) + ":" + str(
                (pygame.time.get_ticks() // 1000 - temps) % 60), 1, couleur)
